...
// Run. Se useMockData for true, gera um novo valor com random walk. Caso contrário, bloqueia até a ISR notificar que há um frame pronto, e então lê o valor do ADC. Em seguida, cria um topic_t para cada amostra do frame e envia para a queue.
void CurrentProducer::run()
{
    if (useMockData) {
        ...
        readADC(); // Envia um topic_t por amostra do frame
    }
}
...
// readADC — um topic_t por amostra 
