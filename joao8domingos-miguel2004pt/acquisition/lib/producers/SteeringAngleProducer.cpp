...
#include "SteeringAngleProducer.h"
...
// run. Se useMockData for true, gera um novo valor com random walk. Caso contrário, lê o valor do sensor via SPI. Em seguida, cria um topic_t e envia para a queue.
