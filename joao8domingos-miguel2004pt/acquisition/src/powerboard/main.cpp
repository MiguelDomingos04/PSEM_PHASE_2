...
extern "C" void app_main(void)
{
    ...
    static TelemetryManager<4, 2, 20> manager;
    ...
    manager.registerConsumers(&lcdConsumer, &mqttConsumer);

    // Registar producers
    manager.registerProducers(&tempProducer, &speedProducer, &canRxProducer);
