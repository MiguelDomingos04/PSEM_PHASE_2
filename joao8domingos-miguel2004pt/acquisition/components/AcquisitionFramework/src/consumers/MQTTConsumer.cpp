...
/*
void MQTTConsumer::consume(consttopic_t1& t)
{
...
void MQTTConsumer::consume(const topic_t1 &t)
{
    if (!base_set) {
...
void MQTTConsumer::packTopic(const topic_t1 &t)
{
...
/*
void MQTTConsumer::packTopic(consttopic_t1& t)
{
...
void MQTTConsumer::mqttInit()
{
    ...
    ESP_ERROR_CHECK(esp_mqtt_client_register_event(mqtt_client, (esp_mqtt_event_id_t)ESP_EVENT_ANY_ID, mqttEventHandler, this));
