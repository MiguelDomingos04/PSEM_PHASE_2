...
void CANRXProducer::setup()
{
    ...
    node_config.io_cfg.tx          = CANRX_TX_GPIO; // GPIO para o sinal de transmissão CAN
    node_config.io_cfg.rx          = CANRX_RX_GPIO; // GPIO para o sinal de
...
//  handleTopic 
// Igual ao switch(frame.id) da Phase 1 mas reconstróitopic_t1
